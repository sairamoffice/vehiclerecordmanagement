# Generated by Django 3.2.20 on 2023-08-25 17:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='vehicleserviceapp.customer')),
                ('mechanic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='vehicleserviceapp.mechanic')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
